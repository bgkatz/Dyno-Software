...
class Ui_DynoControlPanel(object):
    def setupUi(self, DynoControlPanel):
        ...
        self.speedSlider = QtWidgets.QSlider(self.verticalWidget_2)
        ...
        self.label_31 = QtWidgets.QLabel(self.verticalWidget)
        self.label_31.setAlignment(QtCore.Qt.AlignCenter)
        self.label_31.setObjectName("label_31")
        self.gridLayout_9.addWidget(self.label_31, 1, 1, 1, 1)
        self.vescEnable = QtWidgets.QRadioButton(self.verticalWidget)
        self.vescEnable.setEnabled(True)
        self.vescEnable.setText("")
        self.vescEnable.setObjectName("vescEnable")
        self.gridLayout_9.addWidget(self.vescEnable, 1, 0, 1, 1)
        self.verticalLayout_2.addLayout(self.gridLayout_9)
        self.gridLayout_8 = QtWidgets.QGridLayout()
        self.gridLayout_8.setObjectName("gridLayout_8")
        self.label_30 = QtWidgets.QLabel(self.verticalWidget)
        self.label_30.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.label_30.setAlignment(QtCore.Qt.AlignCenter)
        self.label_30.setObjectName("label_30")
        self.gridLayout_8.addWidget(self.label_30, 1, 0, 1, 1)
        self.vescCommand = QtWidgets.QDoubleSpinBox(self.verticalWidget)
        self.vescCommand.setDecimals(0)
        self.vescCommand.setMinimum(-80000.0)
        self.vescCommand.setMaximum(80000.0)
        self.vescCommand.setObjectName("vescCommand")
        self.gridLayout_8.addWidget(self.vescCommand, 1, 1, 1, 1)
        ...
        self.flagButton = QtWidgets.QCheckBox(self.verticalWidget)
        self.flagButton.setObjectName("flagButton")
        self.verticalLayout_2.addWidget(self.flagButton)
    ...
    def retranslateUi(self, DynoControlPanel):
        ...
        self.label_4.setText(_translate("DynoControlPanel", "Speed (rad/s)"))
        ...
        self.label_31.setText(_translate("DynoControlPanel", "VESC"))
        self.label_30.setText(_translate("DynoControlPanel", "Current (mA)"))
        self.logButton.setText(_translate("DynoControlPanel", "Log Data"))
        self.flagButton.setText(_translate("DynoControlPanel", "Flag"))
